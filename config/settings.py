...
INSTALLED_APPS = BASIC_APPS + LIBRARY_APPS + CREATED_APPS
...
LOGGING = {
    ...
    'handlers': {
        # runserver 했을 때, console 에 띄우기 (Debug 설정이 true 일 경우에만 띄우기)
        'console': {
            'level': 'INFO',
        ...
        # runserver 했을 때, 파일로 띄우기 (Debug 설정이 False 일 경우에만 띄우기)
        'file': {
            'level': 'INFO',
